...
const PRINCIPLES = [
  ...
  { num: "03", title: "Create opportunity, create careers.", description: "Higgsfield helps creators monetize their talent and grow professionally — starting with Higgsfield Earn." },
...
const USE_CASES = [
  ...
  { title: "Enterprise Content", description: "Fortune 500 agencies use Higgsfield for campaigns and launches — professional output, maximum efficiency.", image: "https://static.higgsfield.ai/about/Enterprise%20Content.png" },
  ...
  return (
    <div className="min-h-screen bg-hf-bg text-hf-text">
      ...
      <section className="border-b border-white/[0.06] py-24 text-center px-6">
        <p className="mb-3 text-[11px] font-black uppercase tracking-widest text-hf-neon">About Higgsfield</p>
        ...
        <p className="mx-auto mt-6 max-w-2xl text-[16px] text-white/50">
          Higgsfield brings together cinematic intelligence and a unified creative workflow — giving creators, marketing agencies, and filmmakers the power to produce cinematic-quality video and visuals at any scale.
        </p>
      </section>
      ...
      <section className="border-b border-white/[0.06]">
        <img src="https://static.higgsfield.ai/about/main.png" alt="Higgsfield platform" className="w-full object-cover max-h-[500px]" />
      </section>
      ...
      <section className="border-b border-white/[0.06] py-16">
        <div className="mx-auto max-w-5xl px-6">
          <p className="mb-8 text-center text-[15px] font-bold text-white/60">
            Launched in 2025, Higgsfield is on a mission to make professional video and image creation accessible to anyone with an idea.
          </p>
